...
export default function MusicPlayer({ currentSong, onNext, onPrevious, playlist = [] }) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-24 bg-gray-800 border-t border-gray-700 z-50 flex items-center px-4">
      <audio
        ref={audioRef}
      ...
      <div className="flex items-center justify-between w-full max-w-7xl mx-auto gap-4">
        ...
        <div className="flex flex-col items-center flex-1 max-w-lg">
          ...
          <div className="flex items-center gap-2 w-full">
            <span className="text-gray-400 text-xs min-w-10 text-center">
        ...
        {/* Volume Controls */}
        <div className="flex items-center gap-2 min-w-0 w-80 justify-end">
          <button className="text-gray-400 hover:text-white p-2" onClick={toggleMute}>
            {isMuted || volume === 0 ? (
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
