...
export default function SongsGrid({
  ...
  // Handle click on a song card
  const handlePlayClick = (e, song, index) => {
    e.stopPropagation();
  ...
  // Handle click on the whole song card
        ...
        <div className="flex flex-col items-center justify-center py-16 sm:py-20 text-gray-400">
          ...
          >
            <path
              ...
              1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3
              2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3"
            />
          </svg>
          ...
          {songs.map((song, index) => (
            ...
            >
              <div className="relative mb-3 aspect-square">
                ...
                {/* ✅ Play Button (Only works when authenticated) */}
                <button
                  className={`absolute bottom-2 right-2 w-10 h-10 sm:w-12 sm:h-12 ${
                    isAuthenticated ? 'bg-green-500 hover:bg-green-400' : 'bg-gray-600'
                  } rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300 shadow-lg touch-target`}
                ...
                >
                  {isAuthenticated ? (
                    ...
                    >
                      ...
                      10 10-4.48 10-10S17.52 2 12 2zm0
