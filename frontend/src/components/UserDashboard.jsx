      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
            <div>
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mb-2">Welcome back, {user?.fullname?.firstName || 'Music Lover'}!</h1>
              <p className="text-base sm:text-lg text-gray-400">Discover and enjoy your favorite music.</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              ...
              >
                ...
                <span className="text-sm sm:text-base">Discover Music</span>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-800/80 backdrop-blur-sm rounded-lg border border-gray-700 p-4 sm:p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg sm:text-xl font-bold text-white">Popular Playlists</h2>
              <Link
                to="/playlists"
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-700/50 transition-colors touch-target">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="font-semibold text-white text-sm sm:text-base truncate">{playlist.name}</h3>
